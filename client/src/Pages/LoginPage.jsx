    ...
    <div className='lg:h-5/6 '>
      <div className='w-full bg-[#f0f2f5]'>
        <div className='pt-4 pb-8 md:grid md:grid-cols-2 md:py-24 md:pb-28 md:overflow-x-hidden lg:grid lg:grid-cols-2 lg:max-w-6xl lg:mx-auto lg:py-26'>
          <header className='md:relative lg:relative grid grid-cols-1 justify-items-center items-center '>
          ...
          <main className='grid grid-cols-1 justify-items-center mb-24 md:scale-x-105'>
            <form className='border-2 w-96 p-4 pb-6 mt-4 bg-white shadow-xl md:mt-8 rounded-lg '>
              ...
              <Link
                ...
                ref={loginRef}
                className='
                inline-block mt-4 p-2 py-3 pt-2 bg-[#0866ff] text-white rounded-md w-full text-xl font-sans font-bold transition-all focus:ring-blue-300 focus:ring focus:outline-0 focus:transition-all focus:duration-500 hover:bg-[#1877f2] active:ring-0 active:transition-none'
              >
                Log In
              </Link>
